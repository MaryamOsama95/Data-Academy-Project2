...
- Individual judgements aggregated with the **geometric mean** to give one group matrix per level (embedded in `src/ahp_analysis.py`).
...
```
├── src/ahp_analysis.py      # AHP implementation, sensitivity analysis, chart
